...
časopise, učbenike, reklame, koščke papirja, najdene na ulici, kuharske recepte, 
otroške knjige. Karkoli natisnjenega. Stara  sem štiri leta. Pravkar se je začela vojna.
Ta čas živimo v majhni vasi, ki nima železniške postaje, niti elektrike, niti tekoče vode, niti telefona.
Moj oče je edini učitelj v vasi.
Poučuje na vseh stopnjah, od prvega do šestega razreda. V isti učilnici. Šolo loči od naše hiše samo dvorišče 
za odmore in njena okna gledajo na zelenjavni vrt moje mame. Če splezam na zadnje okno v veliki sobi,
vidim vso učilnico in očeta spredaj, kako stoji in piše na tablo.
`
...
function isFarFromLastCharacter() {
  ...
  // (false || false) === false
  return !prevX || (
    ptDistance(prevX, prevY, mouseX, mouseY) > 12
  )
}
